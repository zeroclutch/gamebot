 ...
 */
Discord.DMChannel.prototype.sendEmbed =
  Discord.BaseGuildTextChannel.prototype.sendEmbed =
  Discord.ThreadChannel.prototype.sendEmbed = function(description, title, embedColor) {
  return this.send({
    embeds: [{
