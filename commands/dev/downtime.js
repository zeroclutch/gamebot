    ...
    run: function(msg, args) {
        ...
        if(!args[0] || isNaN(args[0])) {
            ...
            msg.client.shard.broadcastEval(function(client, context) {
                ...
                .forEach(game => 
                    game.channel.sendEmbed("Gamebot is going to be temporarily offline for maintenance in " + args[0] + " minute" + (args[0] == 1 ? "" : "s") + ". Any active games will be automatically ended. For more information, [see our support server.](" + options.serverInvite + ")", `Warning!`, options.colors.warning).catch(logger.error.bind(logger))
                )
